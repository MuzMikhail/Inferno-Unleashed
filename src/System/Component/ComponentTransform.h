...
public:
	...
	[[deprecated( "古い形式です。GetVectorAxisX()を変更してください。エラーが出る場合はVectorAxisX()に変更します" )]] float3 GetXVector()
	{
	...
	[[deprecated( "古い形式です。GetVectorAxisY()を変更してください。エラーが出る場合はVectorAxisY()に変更します" )]] float3 GetYVector()
	{
	...
	[[deprecated( "古い形式です。GetVectorAxisZ()を変更してください。エラーが出る場合はVectorAxisZ()に変更します" )]] float3 GetZVector()
	{
