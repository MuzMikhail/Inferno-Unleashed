...
public:
	...
	void SetSpringArmRotate( float3 rot )
	{
	...
	//! @param vec 向ける方向
	void SetSpringArmVector( float3 vec )
	{
		float trans[ 3 ]{};
		float rot[ 3 ]{};
		float scale[ 3 ]{};
	...
	void SetSpringArmOffset( float3 offset )
	{
		spring_arm_offset_ = offset;
	}

	void SetSpringArmLength( float len )
	{
	...
	void SetSpringArmStrong( float strong )
	{
		spring_arm_strong_ = strong;
	}
	void SetSpringArmReturn( float ret )
	{
